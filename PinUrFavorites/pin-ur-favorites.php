...
if(!class_exists('pin_ur_favs')){
    class pin_ur_favs{
        ...
        private function __construct()
        {
            ...
            $this->templates = array(plugin_dir_url( __FILE__ ) . '/templates/pinned_favorites_temp.php'=>"pinned favorites temp" );
        }
        ...
        public function view_project_template($template){
            ...
            if(!isset($this->templates[get_post_meta($post->ID, '_wo_page_template', true)])){
                return $template;
            }
